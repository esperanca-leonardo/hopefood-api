//package com.esperanca.hopefood.core.aspects.entityinuse;
//
...
//@Aspect
//@Component
//public class EntityInUseAspect {
//
//	@Autowired
...
//		final String exceptionPath = pathHelper.getExceptionPath(className, "InUseException");
//
