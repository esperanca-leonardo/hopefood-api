...
INSERT INTO restaurant (name, kitchen_id, freight_value, cep, complement, district, number, public_place, city_id, created_at, updated_at) VALUES ('Ristorante delizioso', 1, 5.99,'12345-678', 'Apto 101', 'Centro', '123', 'Rua das Flores', 1, utc_timestamp, utc_timestamp);
INSERT INTO restaurant (name, kitchen_id, freight_value, cep, complement, district, number, public_place, city_id, created_at, updated_at) VALUES ('Pizzaria Bella Napoli', 1, 4.99, '98765-432', 'Casa 2', 'Jardim das Palmeiras', '456', 'Av. dos Ipês', 2, utc_timestamp, utc_timestamp);
INSERT INTO restaurant (name, kitchen_id, freight_value, cep, complement, district, number, public_place, city_id, created_at, updated_at) VALUES ('Taco Loco', 2, 6.50, '54321-876', 'Sala 201', 'Vila Nova', '789', 'Rua do Comércio', 3, utc_timestamp, utc_timestamp);
INSERT INTO restaurant (name, kitchen_id, freight_value, cep, complement, district, number, public_place, city_id, created_at, updated_at) VALUES ('El Sabor Auténtico', 2, 7.99, '24680-135', 'Bloco B', 'Bairro Feliz', '246', 'Travessa das Alegrias', 1, utc_timestamp, utc_timestamp);
